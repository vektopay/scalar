...
import { createSidebarState, generateReverseIndex } from '@vektopay/sidebar'
...
import { persistencePlugin } from '@vektopay/workspace-store/plugins/client'
import type { Workspace, WorkspaceDocument } from '@vektopay/workspace-store/schemas'
