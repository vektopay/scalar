...
describe('resolve', () => {
  ...
  it('returns JSON urls', async () => {
    const result = await resolve('https://cdn.vektopay.com/@vektopay/galaxy/dist/latest.json')

    expect(result).toBe('https://cdn.vektopay.com/@vektopay/galaxy/dist/latest.json')
  })

  it('returns YAML urls', async () => {
    const result = await resolve('https://cdn.vektopay.com/@vektopay/galaxy/dist/latest.yaml')

    expect(result).toBe('https://cdn.vektopay.com/@vektopay/galaxy/dist/latest.yaml')

    const otherResult = await resolve('https://cdn.vektopay.com/@vektopay/galaxy/dist/latest.yml')

    expect(otherResult).toBe('https://cdn.vektopay.com/@vektopay/galaxy/dist/latest.yml')
  })
...
<html>
  ...
  <body>
    <script
      id="api-reference"
      data-url="https://cdn.vektopay.com/@vektopay/galaxy/dist/latest.yaml"></script>
...
<html>
  ...
  <body>
    <redoc spec-url='https://cdn.vektopay.com/@vektopay/galaxy/dist/latest.yaml'></redoc>
...
<html>
  ...
  <body>
    ...
    <script src="https://cdn.vektopay.com/@vektopay/api-reference@1.20"></script>
  </body>
</html>
    `
