...
import type { ObjectDoc, UrlDoc } from '@vektopay/workspace-store/client'
import type { OpenApiDocument, InfoObject } from '@vektopay/workspace-store/schemas/v3.1/strict/openapi-document'
